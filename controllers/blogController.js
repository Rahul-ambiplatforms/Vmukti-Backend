...
// ... (createBlog, getBlog, updateBlog, deleteBlog, updateBlogStatus functions remain the same) ...
// You can copy the code you provided for those functions here. Here is just the updated getBlogs function.
...
exports.getBlogs = async (req, res) => {
  try {
    ...
    const totalPipeline = [addFieldsStage, { $match: matchStage }, { $count: "total" }];
...
// ... (The rest of your controller functions: getBlog, updateBlog, deleteBlog, etc.)
